...
export interface Signers {
  ...
  investor5: SignerWithAddress;
  founder1: SignerWithAddress;
  founder2: SignerWithAddress;
  founder3: SignerWithAddress;
  founder4: SignerWithAddress;
  founder5: SignerWithAddress;
}
